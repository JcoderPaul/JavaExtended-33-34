...
/*
Пример на: '$' - конец строки.
*/

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class Less_33_RegEx_Step6 {
    public static void main(String[] args) {
        // Строка где будет вестись поиск
        String my_str = "kreab6-kreabw-abkj34-tbc434-kre1f3-kre456-abl5e-rt4kre";
        /*
        Ищем последовательность:
        'kre' в конце входящей последовательности, т.е. в конце строки,
