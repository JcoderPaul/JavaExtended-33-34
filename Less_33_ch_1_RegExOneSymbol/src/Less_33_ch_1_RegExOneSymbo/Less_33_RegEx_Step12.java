...
/*
Пример на: [ABC] - или A или B или C (простой класс),
...
public class Less_33_RegEx_Step12 {
    public static void main(String[] args) {
        // Строка где будет вестись поиск
        String my_str = "ABKWR - ABDOP - OPERT - ABCER - ABOPE - ABFOP - OYERT - ABCOP";
        /*
        Наш шаблон для поиска, ищем последовательность:
        AB + [один любой из символов в диапазоне от C до F] + OP
        */
